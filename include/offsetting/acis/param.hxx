...
#    endif
     ...
     * Negates a parameter.
     */
    SPAparameter operator-() const { return -val; }
     ...
     * double.
     */
    SPAparameter operator+=(double rhs) { return val += rhs; }
     ...
     * file name.
     */
    void debug(FILE* fp = debug_file_ptr) const { debug_dist(val, fp); }
};
 ...
 * tolerance.
 */
DECL_BASE bool same_par_pos(SPApar_pos const& p1, SPApar_pos const& p2, double tol = SPAresnor);
...
#    endif
     ...
     * given parameter box.
     */
    logical operator<<(SPApar_box const& b) const { return b >> *this; }
...
class DECL_BASE SPApar_transf {
  ...
  public:
     ...
     * v translation.
     */
    SPApar_transf(double u_scale, double v_scale, double u, double v): _r00(u_scale), _r01(0.0), _r10(0.0), _r11(v_scale), du(u), dv(v) { identity_flag = (u_scale == 1.0 && v_scale == 1.0 && u == 0.0 && v == 0) ? 1 : 0; }
...
#    endif
     ...
     * value to set.
     */
    void set_delta_u(double delta_u) { du = delta_u; }
     ...
     * value to set.
     */
    void set_delta_v(double delta_v) { dv = delta_v; }
     ...
     * use identity.
     */
    void set_identity(logical i) { identity_flag = i; }

    // Query Methods
    /**
     * Returns whether or not the given transform is the identity transform.
     */
    logical identity() const { return identity_flag; }
