#pragma once
/*******************************************************************/
/*    @file    gme_ofstapi.hxx                                     */
/*    @brief   Offsetting 模块的接口声明                           */
/*    @details                                                     */
/*                                                                 */
/*    @author  YangHongYuan                                        */
/*    @date    2024.7.4                                            */
...
#if !defined(GME_OFSTAPI_HXX)
#    define GME_OFSTAPI_HXX
 ...
 * <br><br>
 **/
DECL_GME_OFST outcome gme_api_initialize_offsetting();
 ...
 * <br><br>
 **/
DECL_GME_OFST outcome gme_api_terminate_offsetting();
/**
 * @nodoc
 ...
 **/
DECL_GME_OFST outcome gme_api_offset_face(FACE* given_face, double offset_distance, FACE*& offset_face, AcisOptions* ao);
 ...
 * ACIS options such as versioning and journaling.
 **/
DECL_GME_OFST outcome gme_api_offset_face(FACE* given_face, double offset_distance, FACE*& offset_face, offset_options* pOffOpts = NULL, AcisOptions* ao = NULL);
/**
 ...
 * ACIS options such as versioning and journaling.
 **/
DECL_GME_OFST outcome gme_api_offset_face_edge(COEDGE const* given_coedge, double offset_distance, EDGE*& resulting_offset_edge, offset_face_edge_opts* opts = NULL, AcisOptions* ao = NULL);
 ...
 * ACIS options such as versioning and journaling.
 **/
DECL_GME_OFST outcome gme_api_offset_planar_wire(BODY* given_wire, double offset_distance, const SPAunit_vector& wire_normal, BODY*& offset_wire, AcisOptions* ao = NULL);
 ...
 * ACIS options such as versioning and journaling.
 **/
DECL_GME_OFST outcome gme_api_offset_planar_wire(BODY* given_wire, law* offset_law, law* twist_law, const SPAunit_vector& wire_normal, BODY*& offset_wire, int gap_type = 2, logical trim = TRUE, logical overlap = FALSE, AcisOptions* ao = NULL);
 ...
 * ACIS options such as versioning and journaling.
 **/
DECL_GME_OFST outcome gme_api_offset_planar_wire(BODY* iGivenWire, wire_offset_options* iOptons, BODY*& oOffsetWire, AcisOptions* ao = NULL);
 ...
 * ACIS options such as versioning and journaling.
 **/
DECL_GME_OFST outcome gme_api_offset_planar_wire(WIRE* given_wire, TRANSFORM const* trans, double offset_distance, const SPAunit_vector& wire_normal, BODY*& offset_wire, AcisOptions* ao = NULL);
 ...
 * ACIS options such as versioning and journaling.
 **/
DECL_GME_OFST outcome gme_api_offset_face_loops(FACE* iFace, double offset_dist, BODY*& outbody, AcisOptions* ao = NULL);
 ...
 * ACIS options such as versioning and journaling.
 **/
DECL_GME_OFST outcome gme_api_offset_face_loops(FACE* iFace, ENTITY_LIST& iEdges, double iOffsetDist, BODY*& oResultBody, AcisOptions* ao = NULL);
 ...
 * ACIS options such as versioning and journaling.
 */
DECL_GME_OFST outcome gme_api_offset_edges_on_faces(FACE* inp_face, offset_on_faces which_faces, double offset_dist, BODY*& out_wire_body, offset_edges_options* offset_edges_opts, AcisOptions* ao);
 ...
 * ACIS options such as versioning and journaling.
 */
DECL_GME_OFST outcome gme_api_offset_edges_on_faces(LOOP* inp_loop, offset_on_faces which_faces, double offset_dist, BODY*& out_wire_body, offset_edges_options* offset_edges_opts, AcisOptions* ao);
 ...
 * ACIS options such as versioning and journaling.
 */
DECL_GME_OFST outcome gme_api_offset_edges_on_faces(EDGE* inp_edge_of_circuit, double offset_dist, BODY*& out_wire_body, offset_edges_options* offset_edges_opts, AcisOptions* ao);
 ...
 * ACIS options such as versioning and journaling.
 */
DECL_GME_OFST outcome gme_api_offset_edges_on_faces(ENTITY_LIST& coedge_chain, offset_on_faces which_faces, double offset_dist, BODY*& out_wire_body, offset_edges_options* offset_edges_opts, AcisOptions* ao);
