...
outcome gme_api_offset_planar_wire(BODY* given_wire, double offset_distance, SPAunit_vector& wire_normal, BODY*& offset_wire, AcisOptions* ao) {
    ...
    offset_wire = sg_offset_planar_wire(given_wire, offset_distance, wire_normal, arc, 0, 1, 0, 0);
    if(offset_wire) {
