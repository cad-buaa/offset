...
//    SPAposition* v340;                                                                                                        // [rsp+7C0h] [rbp-F38h]
...
//
//    //if(sg_inter_module_header.debug_level >= 0x14) acis_fprintf(debug_file_ptr, "Line_Ellipse Intersection..\n");
...
//            }
//            operator-(&perp_foot, &ell_eq->centre, &perp_offset);
...
//                    if(not_circle) {
//                        SPAparameter::SPAparameter(&v173);
//                        v337 = ell_eq->test_point_tol;
//                        v336 = SpaAcis::NullObj::get_parameter();
//                        if(((unsigned int(__fastcall*)(ellipse*, SPAposition*, __int64, SPAparameter*, SPAparameter*))v337)(ell_eq, &perp_foot, v56, v336, &v173)) {
//                            v339 = ell_eq->eval_position;
//                            v338 = SPAparameter::operator double(&v173);
//                            ((void(__fastcall*)(ellipse*, SPAposition*, __int64, _QWORD, _DWORD))v339)(ell_eq, &v468, v57, 0i64, 0);
//                            v58 = operator-(&v531, &v468, &perp_foot);
//                            v157 = dist_tol > SPAvector::len(v58);
//                            ellipse_tangent = v157;
//                            if(v157) {
//                                interpolate(&v481, 0.5, &perp_foot, &v468);
//                                qmemcpy(&perp_foot, &v481, sizeof(perp_foot));
//                                get_edge_box(&v559, edge1, 0i64, 0, 0i64);
//                                get_edge_box(&v560, edge2, 0i64, 0, 0i64);
//                                v340 = SPAbox::low(&v559, &v532);
//                                v341 = SPAbox::high(&v559, &v533);
//                                v59 = operator-(&v534, v341, v340);
//                                v209 = SPAvector::len(v59);
//                                v342 = SPAbox::low(&v560, &v535);
//                                v343 = SPAbox::high(&v560, &v536);
//                                v60 = operator-(&v537, v343, v342);
//                                v210 = SPAvector::len(v60);
//                                if(v210 <= v209)
//                                    v211 = v210;
//                                else
//                                    v211 = v209;
...
//                                    v214 = v212;
//                                v215 = v214;
//                                SPAunit_vector::SPAunit_vector(&v469, &st_eq->direction);
//                                v61 = operator*(&v538, v215, &v469);
//                                operator-(&v482, &perp_foot, v61);
//                                v62 = operator*(&v539, v215, &v469);
//                                operator+(&v483, &perp_foot, v62);
//                                v158 = !EDGE::closed(edge2) && (ell_str_sol || ell_end_sol) || str_str_sol || str_end_sol;
